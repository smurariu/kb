...
Ex: defintion of done; an ubiqutous language for referring to the Scrum process
...
Self-organizing means nobody tells them (the po, dev team and scrum master) how to do their job

Cross-functional means that they have all the competencies necessary to do the work and they depend on external parties.
...
The PO is the sole responsible for managing the PRODUCT Backlog and this includes:

- Clearly expressing the Backlog Items
- Ordering items to best achieve goals and missions
- Optimize the VALUE of the work that the Dev Team performs
- Ensuring that the Backlog is visible, transparent and shows what the team will work on next
- Ensuring that the dev team understands the items on the Backlog to the level needed for them to perform the work

The PO may represent others but is ONE PERSON. For a PO to succeed the entire organization must respect her decissions. 

## The Dev Team
A team whos members create the Increment of "done". The dev teams are structured by the organization and empowered to organize and manage their own work thus optimizing their efficiency and effectiveness.
...
- Members may have specialized skills but accountability belongs to the Dev Team as a whole

Size (matters)
- Small enough to remain agile
- No less than three
- No more than nine
- PO excluded. Scrum master excluded unless a developer.
...
- Ensuring the PO knows how to arrange PBIs to maximize value
- Helps the PO understand and practice Agility
...
- PO discusses the OBJECTIVE (different from the Sprint Goal)
- PO discusses the PBIs that, if completed, would achieve the OBJECTIVE
...
### How to do it
Having selected the PBIs that will be implemented during the sprint the Dev Team decides how to do it.
The PBIs PLUS A PLAN on how to deliver them is called a Sprint Backlog.

The Dev Team starts by designing the system and the work needed to convert the backlog into a working product increment.
Work scheduled to be executed during the first days of a siprint is decomposed into units of a day or less.

The PO may help clarify PBIs. The dev team may renegociate PBIs with the PO. The dev team may invite other people in order to provide technical or domain experitze.

By the end of the Sprint Planning the Dev Team should be able to explain to PO and SM how it plans to deliver the product increment.
...
The Dev Team inspects progress toward the Sprint Goal. Often members meet immediately after this meeting for detailed discussions or to adapt/replan the rest of the Sprint's work.
It is a key inspect and adapt meeting.

The Scrum Master enforces the rule that only members of the dev team attend.
...
- Scrum Team + key stakeholders invited by the PO
- The PO explains what items have been "Done" and what has not been "Done"
- The Dev Team explains what went well, problems it ran into and how they were solved
- The Dev Team demonstrates the product increment, and answers questions about it
- The PO discusses the Backlog as it stands, projecting likely completion dates
...
The Srum Master participates as a peer in the meeting, being accountable over the Scrum Process.
...
Ordered list of everything that might be needed in the product. Single source of requirements for any changes. The PO is responsible for the content, avaiability and ordering of the Product Backlog. 
...
If multiple teams work on the same product they share the SAME Backlog. In this case an additional attribute of each PBI can be added to designate the team working on it. 


### Product Backlog Refinement
- is the act of adding **detail**, **estimates** and **order** to the PBIs. 
- is an ongoing process in which the PO and the Dev Team collaborate on the details of the PBIs
- the Scrum Team decides how and when it is done
- must consume no more than 10% of the capacity of the dev team
- however, the PBIs can be updated at any time by the PO
...
The people who will perform the work (dev team) make the estimate. 

## Monitoring Progress Towards a Goal
At any point the work remaning to reach a goal can be summed. 
The PO tracks this total work remaining at least every Sprint Review. 
The PO compares the remaing work with the remaining work at the end of the previous sprints to asses progress towards a goal.
...
It makes visible all the work that the Dev Team identifies as necessary to meet the sprint goal.

It is a plan with enough detail so that changes in progress can be understood during the Daily Scrum.
It emerges during the Sprint as the Dev Team learns more about the work needed to reach the Sprint Goal.
Only the Dev Team can change the Sprint Backlog during the Sprint.

## Monitoring Sprint Progress
At any point in the Sprint, the work needed to reach the Sprint Goal can be summed up.
The Dev Team tracks this total at every Daily Scrum to project the likelihood of achieving the Sprint Goal. 
This enables the Dev Team to track its progress.

## Increment
The Increment is the sum of all the PBIs completed during the Sprint that meet the definition of Done.
These increments must be in usable and releasable condition regardless if the PO decides to release it or not.
...
The Scrum Master must work with the PO, Dev Team and everybody involved to understand if the artifacts are completely transparent. 
